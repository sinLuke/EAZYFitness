...
class TimeTable: NSObject {
    ...
    static let VERTICALRATIO:CGFloat = 15
            ...
            for i in 0...7{
                    ...
                    if let DicForOneStudent = timetable[eachTimetable] as? NSDictionary{
                        for eachDay in DicForOneStudent.allKeys{
                            if let courseTimeList = DicForOneStudent[eachDay] as? [Int]{
                                ...
                                let height = CGFloat((courseTimeList[0])*eachTimeScopeHeight/2)
                                let CourseView = UIView(frame: CGRect(x: 0, y: (value1)*eachTimeScopeHeight/100 + eachTimeScopeHeight/2, width: 10, height: 10)
                ...
                case 0:
                    ...
                    for j in 0...timeScope-1{
                        ...
                        eachTimeScopeLabel.text = convertTimeIntoString(timeNumber: j*100+startTime*100)
