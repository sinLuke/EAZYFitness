...
class TrainerTableVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let sortedKeys = (dic.allKeys as! [String]).sorted { $0 < $1 }
        cell.textLabel?.text = "\((dic.value(forKey: sortedKeys[indexPath.row]) as? NSDictionary)?.value(forKey: "trainerID") ?? sortedKeys[indexPath.row])"
