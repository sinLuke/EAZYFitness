...
- Courses for student have `note`. *Like the reson been declined or any other string typed by students or trainers.*
...
-------- | ---| ---| ---| ---| ---| ---|
`deleted` | notify[^1] | notify[^1] | hide | hide | `0` | `0` |
`decline`    | hide | hide[^3] |hide | hide |`0` | `0` |
`waitForTrainer`     | hide |hide |hide | hide |`0` | `0` |
`waitForStudent` | hide | hide |menu[^4] | hide|`0` | `0` |
`approved`| show |show |hide |show[^5] |`0` | `1` |
`scaned`     | hide[^2] |show |hide |hide |`1` | `1` |
`ill` | hide[^2] |show |hide |hide |`0` | `1` |
`noStudent`    | hide[^2]|show |hide |hide |`0` | `1` |
`noTrainer`    | hide[^2]|show |hide |hide |`0` | `0` |
`noCard` | hide[^2]|show |hide |hide |`0` | `1` |
`other`    | hide[^2]|show |hide |hide |`0` | `0` |
`noCardFirst`     | hide[^2]|show |hide |hide |`0` | `0` |
`noStudentFirst`    |hide[^2]|show |hide |hide |`0` | `0` |
...
`deleted` | notify[^1] | notify[^1]| hide | hide | `0` | `0` |
`decline`    | hide | hide[^3] |hide | hide |`0` | `0` |
`waitForTrainer`     | hide |hide | menu[^4]| hide |`0` | `0` |
`waitForStudent` | show | hide |hide | show|`0` | `0` |
`approved`| show |show |hide |show[^5] |`0` | `0` |
`scaned`     | hide[^2] |hide |hide |hide |`1/n` | `1/n` |
`ill` | hide[^2] |hide |hide |hide |`0` | `1/2n` |
`noStudent`    | hide[^2]|hide |hide |hide |`0` | `1/2n` |
`noTrainer`    | hide[^2]|hide |hide |hide |`0` | `0` |
`noCard` | hide[^2]|hide |hide |hide |`0` | `1/2n` |
`other`    | hide[^2]|hide |hide |hide |`0` | `1/2n` |
`noCardFirst`     | hide[^2]|hide |hide |hide |`1` | `1/n` |
`noStudentFirst`    |hide[^2]|hide |hide |hide |`0` | `1/2n` |
...
#### Infomation Page
- contains all the overview statistical data for the same `region` (all region for "super"), *like the sum of courses hours been finished and settlemented*
- contains all the statistical data for students and trainers for the same `region` (all region for "super") *like the sum of courses hours been finished and settlemented for a single student and trainer (all his/her students), the sum of absents and exceptions been recorded*
- contains the statistical data for settlemented course hours for students and trainers.

[^1]: Notify will disappear after user dismiss it.
[^2]: Future courses cannot be marked as scaned, ill, etc. (This status is impossible)
[^3]: Course cannot be declined within 24 hours of the start of the course. (This status is impossible)
[^4]: Provide option for approved or decline.
[^5]: Course that been approved cannot be rescheduled within 24 hours of, or after, the start of the course.
